...
| `@map` | Karte, Bewertung & Hover (`map-evaluation.feature`, `road-hover.feature`) | 11 |
| `@navigation` | Navigation (`navigation.feature`) | 3 |
| `@statistics` | Statistik-Seite (`statistics.feature`) | 2 |
| `@req-3` | Anforderung 3 – Straßen nach Bewertung einfärben | 8 |
...
| `@TF-1` | Testfall 1 – Straßenzustand nach Bewertungsart auf der Karte beurteilen (`map-evaluation.feature`, `road-hover.feature`) | 11 |
